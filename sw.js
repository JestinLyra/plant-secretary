const CACHE='plant-secretary-v6';
...
const decorate=async response=>{
  ...
  const html=text.replace('</head>','<link rel="stylesheet" href="home-art.css?v=6"></head>').replace('</body>','<script src="home-art.js?v=5"></script></body>');
