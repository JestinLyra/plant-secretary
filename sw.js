const CACHE='plant-secretary-v29';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./home-art.css','./home-art.js','./my-plants-display.js','./app-prefs.js','./app-actions.js','./photo-editor.js','./profile-care-summary.js','./assets/home-sunlight.webp','./assets/home-ph.webp','./assets/home-controls.webp','./assets/water-drop.webp','./assets/heading-logo.jpg'];
const decorate=async response=>{
  ...
  text=text
    ...
    .replace('✂️ <b>Prune / Pinch</b><br>Track in history','✂️ <b>Prune / Pinch</b><br><span data-care-summary="prune"></span>');
  const html=text
    .replace('</head>','<link rel="stylesheet" href="home-art.css?v=17"></head>')
    .replace('</body>','<script src="home-art.js?v=9"></script><script src="my-plants-display.js?v=1.0.13"></script><script src="app-prefs.js?v=1.0.16"></script><script src="app-actions.js?v=1.0.6"></script><script src="photo-editor.js?v=1.0.14"></script><script src="profile-care-summary.js?v=1.0.16"></script></body>');
