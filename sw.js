const CACHE='plant-secretary-v10';
...
const decorate=async response=>{
  ...
  const html=text.replace('</head>','<link rel="stylesheet" href="home-art.css?v=10"></head>').replace('</body>','<script src="home-art.js?v=9"></script></body>');
