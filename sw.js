const CACHE='plant-secretary-v11';
...
const decorate=async response=>{
  ...
  const html=text.replace('</head>','<link rel="stylesheet" href="home-art.css?v=11"></head>').replace('</body>','<script src="home-art.js?v=9"></script></body>');
