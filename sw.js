const CACHE='plant-secretary-v4';
...
const decorate=async response=>{
  ...
  const html=text.replace('</head>','<link rel="stylesheet" href="home-art.css?v=4"></head>').replace('</body>','<script src="home-art.js?v=4"></script></body>');
