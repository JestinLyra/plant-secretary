const CACHE='plant-secretary-v18';
...
const decorate=async response=>{
  ...
  const html=text.replace('</head>','<link rel="stylesheet" href="home-art.css?v=13"></head>').replace('</body>','<script src="home-art.js?v=9"></script><script src="my-plants-display.js?v=1.0.5"></script><script src="app-prefs.js?v=1.0.5"></script><script src="app-actions.js?v=1.0.4"></script><script src="photo-editor.js?v=1.0.5"></script></body>');
